...
datos = np.loadtxt("termalizacion_n32_300k_10temp_J-1_B1.csv", delimiter = ',', skiprows=1)
...
np.save('B_1_J-1_rho_m', rho_m)
np.save('B_1_J-1_rho_m_rho_e', rho_e)
...
np.save('B_1_J-1_rho_prom_m_{:d}'.format(particiones), rho_prom_m)
np.save('B_1_J-1_rho_prom_e_{:d}'.format(particiones), rho_prom_e)
